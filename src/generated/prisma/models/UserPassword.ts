...
export type UserPasswordWhereInput = {
  ...
  userId?: Prisma.StringFilter<"UserPassword"> | string
...
export type UserPasswordScalarWhereWithAggregatesInput = {
  ...
  userId?: Prisma.StringWithAggregatesFilter<"UserPassword"> | string
...
export type UserPasswordOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"userId" | "passwordHash" | "createdAt" | "updatedAt", ExtArgs["result"]["userPassword"]>
...
export interface UserPasswordDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const userPasswordWithUserIdOnly = await prisma.userPassword.findMany({ select: { userId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many UserPasswords and only return the `userId`
   * const userPasswordWithUserIdOnly = await prisma.userPassword.createManyAndReturn({
   *   select: { userId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more UserPasswords and only return the `userId`
   * const userPasswordWithUserIdOnly = await prisma.userPassword.updateManyAndReturn({
   *   select: { userId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface UserPasswordFieldRefs {
  readonly userId: Prisma.FieldRef<"UserPassword", 'String'>
